...
<head>
    ...
    <link type="text/css" 
	href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/themes/base/jquery-ui.css" rel="stylesheet" />
    <!-- Menu CSS -->
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <div class="top-left-part">
                    <!-- Logo -->
                    <a style="color:black;" href="#"> Admin panel </a>
                </div>
                <!-- /Logo -->
            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a href="/admin" class="waves-effect">Dashboard</a>
                    </li>
                    <li>
                        <a href="/admin-product" class="waves-effect">Products</a>
                    </li>
                    <li>
                        <a href="/admin-category" class="waves-effect">Categories</a>
                    </li>
                    <li>
                        <a href="/admin-user" class="waves-effect">Users</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/admin-tag" class="waves-effect">Tags</a>
                    </li>
                    <li>
                        <a href="{{ route('user.logout') }}" class="waves-effect">LogOut</a>
                    </li>
